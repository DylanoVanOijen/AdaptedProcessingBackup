...
for file in files:
    ...
    snr_values.extend([snr_data['mean_DT'], snr_data['mean_DTB'], snr_data['mean_DT']-snr_data['mean_DTB'], snr_data['peak_DT'], snr_data['peak_DTB'], snr_data['peak_DT']-snr_data['peak_DTB'], snr_data['elevation']])
