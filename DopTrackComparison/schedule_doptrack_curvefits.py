...
LOC = '/home/doptrackbox/DTB_Recordings/locally_processed/Processed/DopTrack/'
...
def get_unprocessed_recordings():
    ...
    all_files = os.listdir(LOC+"RawSignalsFreq/")
...
for file_base in unprocessed_files:
    print(f"[INFO] Launching curvefit for: {file_base}")
    result = subprocess.run(["python3", "doptrack_curvefit.py", file_base])
