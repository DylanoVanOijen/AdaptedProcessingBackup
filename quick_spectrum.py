...
""" files_dates = ['202507250446', 
               ...
               '202507280441',
               '202507280616',] """
files_dates = ['202502261425', '202507281600', '202500000000', '202500000001', '202507301300', '202507301400'] # test recording of 100.7Mhz
...
def process_dataset_ADEV(file, tune_freq, freq_offset, dt, sampling_rate, mask_width):
    sig_freqs, time, freqs, spec = extract_signal(load_data(file, dt), dt, sampling_rate, tune_freq, freq_offset, mask_width)   
    label = file
...
for file in files_dates:
    ...
    dt = 2 # Time resolution of the FFT
    theoretical_freq = TUNE
    mask_width = sample_rate
    process_dataset_ADEV(FILE, TUNE, CORR, dt, sample_rate, mask_width)
